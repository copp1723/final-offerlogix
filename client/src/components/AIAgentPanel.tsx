import { Sparkles, Send, Bot, Wand2, Rocket, Target, Brain, MessageCircle, Activity, Plus } from 'lucide-react';
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (e instanceof APIError) {
        ...
        setChatHistory((h) => [...h, { role: 'ai', message: 'An unexpected error occurred. Please try again.' }]);
      }
    } finally {
      setLoading(false);
    }
        ...
        <div className="relative text-center">
          ...
          <div className="mt-8">
            <button
              ...
              className="inline-flex items-center gap-3 px-8 py-4 gradient-primary text-white rounded-2xl font-semibold text-lg hover:shadow-glow transform hover:scale-105 transition-all duration-300"
            >
