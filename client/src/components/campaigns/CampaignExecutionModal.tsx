        ...
        <Tabs defaultValue="execute" className="space-y-4">
          ...
          <TabsContent value="execute" className="space-y-4">
            ...
            {executionResults && (
              <Card>
                <CardHeader>
                  <CardTitle className="text-green-600 dark:text-green-400">Execution Results</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="text-center">
                      <p className="text-2xl font-bold text-green-600 dark:text-green-400">{executionResults.successful || 0}</p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Successful</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-red-600 dark:text-red-400">{executionResults.failed || 0}</p>
                      <p className="text-sm text-gray-600 dark:text-gray-400">Failed</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{executionResults.total || 0}</p>
              ...
              <CardContent className="space-y-4">
                {templates.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-gray-400 dark:text-gray-500">Generate templates using AI to get started</p>
                  </div>
                ) : (
                    ...
                    <Card key={index}>
                      ...
                      <CardContent>
                        <div className="space-y-2">
                          ...
                          <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded text-xs max-h-32 overflow-y-auto">
