...
// Campaign IDs for Nissan Davenport
const CAMPAIGNS = {
  suvs: '60e82edd-cbe7-4922-b04e-0301977c0931',
  trucks: '0d0d719e-314b-4cdd-9382-596649666c24'
};

const AGENT_ID = '0f4c6f1b-a023-47e4-95f8-3e612c91392d'; // Maddie Carson
...
async function importLeads() {
  ...
  try {
    console.log('🚗 Importing Nissan Davenport leads...');
    
    // Import SUV leads
    console.log('\n📋 Processing SUV leads...');
    const suvData = parseCSV('./nissan-davenport-suvs.csv');
    ...
    const truckData = parseCSV('./nissan-davenport-trucks.csv');
