...
User Message: ${userMessage}`;
  ...
  // Note: suggestionsByStep is now properly isolated per conversation to prevent cross-session bleed
  ...
  const substantive = await this.isSubstantiveAnswer(currentStepData, userMessage);
      ...
      if (currentStep === 'context') {
        ...
        // Clean up internal fields before persisting to prevent data leakage
        const cleanedData = { ...updatedData };
        delete cleanedData._rawContextInput;
        delete cleanedData._bootstrapSummary;
        delete cleanedData._contextConfidence;
        delete cleanedData._autoGoalsExtracted;
        delete cleanedData._usedOpeners;
